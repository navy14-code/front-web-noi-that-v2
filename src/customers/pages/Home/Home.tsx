    ...
    <>
      <div className="space-y-5 lg:space-y-10 px-5 lg:px-20 relative pb-20">
        <section className="pt-10 lg:px-20 relative h-full lg:h-[550px] object-cover">
          ...
          />
          <div
            className="absolute top-3/4 left-4 lg:left-[15rem] transition-transform duration-900 hover:scale-95 
        ...
        <CategoryGrid />
        <div className="pt-10">
          <h1 className=" text-lg lg:text-4xl font-bold text-primary-color text-center px-5 pb-10">
            KHUYẾN MÃI HÔM NAY
          </h1>
          <Deal />
        </div>

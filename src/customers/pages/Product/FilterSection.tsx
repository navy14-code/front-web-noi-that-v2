                            ...
                            {price.slice(0, expandPrice ? price.length : 3).map((item) =>
                                <FormControlLabel
                                    ...
                                    label={<div >
                                        <p>{item.name}</p>
                                        <span
                                            style={{ backgroundColor: item.name === "Dưới 1 triệu" ? "#00927c" : "#fff" }}
                                            className={`h-5 w-5 rounded-full ${item.name === "Dưới 1 triệu" ? "bg-[#00927c]" : "bg-white"}`}>
                            ...
                            {discount.slice(0, expandDiscount ? discount.length : 3).map((item) =>
                                <FormControlLabel
                                    ...
                                    label={<div >
                                        <p>{item.name}</p>
                                        <span
                                            style={{ backgroundColor: item.name === "10% trở lên" ? "#00927c" : "#fff" }}
                                            className={`h-5 w-5 rounded-full ${item.name === "10% trở lên" ? "bg-[#00927c]" : "bg-white"}`}>
